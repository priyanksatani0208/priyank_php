			...
			<div class="inner-sec-w3ls-agileits py-lg-5 py-3">
				<div class="row">
					...
					<div class="col-lg-4 footer-grid1-wthree-agileits text-left">
						...
						<ul class="footer-bottom-list">
							...
							<li>
								<span class="fas fa-phone"></span> +9909879421 </li>
							<li>
								<span class="fas fa-fax"></span> +7573095856 </li>
							<li>
						...
						<div class="tech-btm">
							...
							<div class="blog-grids row mb-3">
								...
								<div class="col-sm-8 blog-grid-right">
									...
									<h5>
										<a href="about ">Pellentesque dui, non felis. Maecenas male non felis </a>
									</h5>
									<div class="sub-meta">
										<span>
											<i class="far fa-clock"></i> 20 Sep, 2023</span>
									</div>
								</div>
							...
							<div class="blog-grids row mb-3">
								...
								<div class="col-sm-8 blog-grid-right">
									...
									<div class="sub-meta">
										<span>
											<i class="far fa-clock"></i> 23 Sep, 2023</span>
									</div>
								</div>
				...
				<div class="footer-cpy text-center pt-5 mt-5">
					<div class="copyrightbottom-w3ls-agile">
						<p>© 2023 Rambling. All Rights Reserved | Design by divya & priyank
