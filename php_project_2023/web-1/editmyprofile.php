		...
		<div class="container-login100">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Mobile-Number is required">
						...
						<input type="number" class="input100"  name="cust_mob_num" placeholder="Enter Mobile-Number" value="<?php echo $fetch->cust_mob_num;?>">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-26" data-validate="Address is required">
						<span class="label-input100">Address</span>
						<input name="address" class="input100" placeholder="Enter Address" value="<?php echo $fetch->address;?>">
						<span class="focus-input100"></span>
					</div>
