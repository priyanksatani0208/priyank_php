 	...
 	<!---->
        ...
        <form>
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Service Provider Name" required="">
            </div>
            ...
            <div class="col-md-12 form-group1 form-last">
              ...
              <input type="text" placeholder="Mobile Number" name="sp_mobile" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
              ...
              <textarea  placeholder="Address" name="sp_add" required="">Address</textarea>
            </div>
             <div class="clearfix"> </div>

             <div class="col-md-12 form-group1 ">
              <label class="control-label">Pincode</label>
              <input type="text" placeholder="Mobile Number" name="sp_pincode" required="">
            </div>
             <div class="clearfix"> </div>
           ...
           <!--   <div class="col-md-12 form-group1 group-mail">
            ...
            <div class="col-md-12 form-group1 group-mail">
              ...
              <input type="date" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="" name="Created_dt">
            </div>
             <div class="clearfix"> </div>
