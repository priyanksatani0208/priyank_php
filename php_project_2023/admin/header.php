...
<!----->
        <nav class="navbar-default navbar-static-top" role="navigation">
             <div class="navbar-header.php">
               ...
               <h1> <a class="navbar-brand" href="dashboard.php">MSP</a></h1>         
			   </div>
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="dashboard.php" class=" hvr-bounce-to-right"><i class="fa fa-dashboard.php nav_icon "></i><span class="nav-label">service &nbsp;&nbsp; provider <center>dashboard.php</center></span> </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="add_product.php" class=" hvr-bounce-to-right"> <i class="fa fa-user nav_icon"></i>Add Product</a></li>
                            
                            <li><a href="manage_product.php" class=" hvr-bounce-to-right"><i class="fa fa-user nav_icon"></i>Manage Product</a></li>		
					   </ul>
                    </li>
