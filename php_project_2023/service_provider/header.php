		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <li><a href="add_company" class=" hvr-bounce-to-right"> <i class="fa fa-user nav_icon"></i>Add Company</a></li>
                        <li><a href="add_model" class=" hvr-bounce-to-right"> <i class="fa fa-user nav_icon"></i>Add Model</a></li>
