		  ...
		  switch($path)
		  {
			  ...
			  if(isset($_REQUEST['submit']))
			{
				...
				move_uploaded_file($dup_file,$path);
		 		...
		 		$arr=array("service_name"=>$service_name,"service_price"=>$service_price,"service_desc"=>$service_desc,"service_img"=>$service_img,"com_name"=>$com_name,"$mod_name"=>$mod_name,"$com_img"=>$com_img,"$mod_img"=>$mod_img);
