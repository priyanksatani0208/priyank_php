...
<!----->
        <nav class="navbar-default navbar-static-top" role="navigation">
             <div class="navbar-header.php">
               ...
               <h1> <a class="navbar-brand" href="dashboard.php">Mobile Services</a></h1>         
			   </div>
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="view_payment" class=" hvr-bounce-to-right"><i class="fa fa-user nav_icon"></i> <span class="nav-label">View Payment</span> </a>
                    </li>

					 <li>
                        <a href="view_contact" class=" hvr-bounce-to-right"><i class="fa fa-user nav_icon"></i> <span class="nav-label">View Contact</span> </a>
                    </li>
					 <li>
                        <a href="view_feedback" class=" hvr-bounce-to-right"><i class="fa fa-user nav_icon"></i> <span class="nav-label">View Feedback</span> </a>
                    </li>
					 <li>
