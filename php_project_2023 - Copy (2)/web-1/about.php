...
<div class="container">
<h3 class="mb-lg-4 mb-md-3 mb-sm-2 mb-2">ABOUT US</h3><br>
<div class="row">
<div class="col-md-6 com-sm-6 w3three_al1">
<h4 class="mb-lg-4 mb-md-3 mb-sm-2 mb-2">Take A Look About Our Company</h4>
<p class="mb-lg-4 mb-md-3 mb-sm-2 mb-2">Mobile services is the largest mobile phone service chain in Ahmedabad, also the biggest Mobile service provider. We are a one-stop solution for all needs related to the repair of android & IOS smartphones. The company aims to solve the problems in the repairing industry. Mobile Services offers repairs and services for smartphones, mobile ,all major brands, including Apple, iPhone, OnePlus, Redmi, Mi, Oppo, Vivo, Xiaomi, Google Pixel, Samsung and Realme phone..</p>

<p>At Mobile Services, we serve all our customers across Ahmedabad with best in the mobile repairing sector at most affordable prices. We provide certified service partners for major branded phones. We provide quality smartphone repairs with 100% customer satisfaction.We provide wide range of mobile phone services as online mobile repair, doorstep mobile repair.</p>
</div>
...
<div class="test-wel">
						...
						<p>We offer a wide range of mobile repair services, such as:</p>
						<ul>
							<li>
								<i class="fas fa-check"></i>Replacement of the screen</li>
							<li>
								<i class="fas fa-check"></i>Replacement of microphone</li>
							<li>
								<i class="fas fa-check"></i>Replacement of battery,</li>
							<li>
								<i class="fas fa-check"></i>Fixing speaker receiver and charging jack and more</li>
						</ul>
					</div>
</div>
<div class="col-md-6 com-sm-6 w3three_al3">
<img src="images/our_service.jpg" alt="" class="img-fluid">
</div>
</div>
					</div>
...
<div class="test-wel">
						...
						<ul>
							<li>
								...
								<i class="fas fa-check"></i> Be Sure of 100% Genuine Mobile Parts at the Most Affordable Prices.</li>
							    <li><i class="fas fa-check"></i>Insure You Get Mobile Repair Services at the Most     Competitive Prices.</li>
							
						</ul>
					</div>
</div>
<div class="col-md-6 com-sm-6 w3three_al5">
<img src="images/val.jpg" alt="" class="img-fluid">
</div>
</div>
					</div>
					<div class="tab3">
...
<div class="test-wel">
						...
						<ul>
							<li>
								<i class="fas fa-check"></i>Certified professional team repair your device!</li>
				
						</ul>
					</div>
</div>
<div class="col-md-6 com-sm-6 w3three_al7">
<img src="images/instant.jpg" alt="" class="img-fluid">
</div>
</div>	
					</div>
					<div class="tab4">
...
<div class="test-wel">
						...
						<ul>
							<li>
								<i class="fas fa-check"></i>Yore Mobile Data is secure..!</li>
				
						</ul>
					</div>
</div>
<div class="col-md-6 com-sm-6 w3three_al9">
<img src="images/security.jpg" alt="" class="img-fluid">
</div>
</div>
					</div>
					</div>
